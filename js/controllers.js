...
angular.module('myApp').controller('oneGroupItemsController', function($scope,$rootScope) {
	$scope.applyFilter = function (){
		...
		var selectedObject = $scope.$parent.updateVar.selectedObject;
...
angular.module('myApp').controller('initController', function($scope,$rootScope,$http,$routeParams,SPARQLService,Utilities) {
	...
	var dataConfURIs = ["http://localhost:8000/data4.1.conf"];
	//var dataConfURIs = ["https://raw.githubusercontent.com/noorbakerally/EGC2017ConfigurationFile/master/data5.conf"];
